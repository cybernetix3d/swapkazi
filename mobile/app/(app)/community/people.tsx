    ...
    try {
      ...
      const mockUsers: User[] = [
        ...
        },
        {
          ...
          bio: 'Social media manager with experience in content creation and community management.',
          avatar: 'https://randomuser.me/api/portraits/women/6.jpg',
          phoneNumber: '+27 83 678 9012',
        ...
        },
        {
          ...
          phoneNumber: '+27 71 789 0123',
          skills: ['Full-Stack Development', 'Node.js', 'React'],
          location: {
            type: 'Point',
            coordinates: [18.4241, -33.9249],
        ...
        },
        {
          ...
          bio: 'UX/UI designer with a focus on user-centered design and accessibility.',
